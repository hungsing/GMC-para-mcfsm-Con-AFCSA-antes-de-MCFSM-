...
\item $\delta_{ER\mathit{Buf}}: Q_{ER} \times \Sigma_{ER\mathit{Buf}} \times Q$ y decimos que $\forall q \in Q_\mathit{ER}, \ m \in \mathcal{M} \ | \ \langle q, b_\mathit{ERi} \gg m, q' \rangle \in \delta_\mathit{ERBuff} \iff \exists \sigma_i \in s \land \sigma_i = b_\mathit{ERi} \ll m$  donde s es una secuencia de la forma $[q_1, \sigma_1, q_2,...,\sigma_n, q_n]$ con $q_n = q$% comunicación interna
